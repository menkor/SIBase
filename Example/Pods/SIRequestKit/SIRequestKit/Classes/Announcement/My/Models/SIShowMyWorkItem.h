...
@interface SIShowMyWorkItem : NSObject
...
*/
@property (nonatomic, copy, nullable) NSString *announcementName;
...
/**
 ...
 name        : createTime
*/
@property (nonatomic, strong, nullable) NSNumber /*int64_t*/ *createTime;
